...
|                      |                                                                                                                      |
| -------------------- | -------------------------------------------------------------------------------------------------------------------- |
| **Repo**             | [github/github-mcp-server](https://github.com/github/github-mcp-server) ⭐ 32,504 \| 🐛 327 \| 🌐 Go \| 📅 2026-08-25 |
...
| [modelcontextprotocol/server-gitlab](https://github.com/modelcontextprotocol/servers/tree/main/server-gitlab) ⭐ 89,863 \| 🐛 548 \| 🌐 TypeScript \| 📅 2026-08-20 | Reference GitLab server implementation. |
...
| [modelcontextprotocol/server-git](https://github.com/modelcontextprotocol/servers/tree/main/server-git) ⭐ 89,863 \| 🐛 548 \| 🌐 TypeScript \| 📅 2026-08-20 | Reference local Git server implementation. |
...
|                  |                                                                                                                                |
| ---------------- | ------------------------------------------------------------------------------------------------------------------------------ |
| **Repo**         | [hashicorp/terraform-mcp-server](https://github.com/hashicorp/terraform-mcp-server) ⭐ 1,513 \| 🐛 48 \| 🌐 Go \| 📅 2026-08-25 |
...
|                  |                                                                                                                     |
| ---------------- | ------------------------------------------------------------------------------------------------------------------- |
| **Repo**         | [hashicorp/vault-mcp-server](https://github.com/hashicorp/vault-mcp-server) ⭐ 59 \| 🐛 21 \| 🌐 Go \| 📅 2026-08-25 |
...
|                   |                                                                                                                                    |
| ----------------- | ---------------------------------------------------------------------------------------------------------------------------------- |
| **Repo**          | [containers/kubernetes-mcp-server](https://github.com/containers/kubernetes-mcp-server) ⭐ 2,021 \| 🐛 92 \| 🌐 Go \| 📅 2026-08-25 |
...
|                   |                                                                                                                                     |
| ----------------- | ----------------------------------------------------------------------------------------------------------------------------------- |
| **Repo**          | [Flux159/mcp-server-kubernetes](https://github.com/Flux159/mcp-server-kubernetes) ⭐ 1,577 \| 🐛 6 \| 🌐 TypeScript \| 📅 2026-08-08 |
...
| [manusa/kubernetes-mcp-server](https://github.com/manusa/kubernetes-mcp-server) ⭐ 2,021 \| 🐛 92 \| 🌐 Go \| 📅 2026-08-25    | Kubernetes + OpenShift support.                                                                      |
...
| [kubestellar/console](https://github.com/kubestellar/console) ⭐ 127 \| 🐛 47 \| 🌐 TypeScript \| 📅 2026-08-26                | AI-powered multi-cluster management dashboard with MCP server (kc-agent) for AI-assisted operations. |
...
|                  |                                                                                                                              |
| ---------------- | ---------------------------------------------------------------------------------------------------------------------------- |
| **Repo**         | [solomon2773/nora](https://github.com/solomon2773/nora) ⭐ 47 \| 🐛 17 \| 🌐 TypeScript \| 📅 2026-08-25                      |
...
|                  |                                                                                                                   |
| ---------------- | ----------------------------------------------------------------------------------------------------------------- |
| **Repo**         | [portainer/portainer-mcp](https://github.com/portainer/portainer-mcp) ⭐ 221 \| 🐛 7 \| 🌐 Python \| 📅 2026-08-13 |
...
| [wonderwhy-er/DesktopCommanderMCP](https://github.com/wonderwhy-er/DesktopCommanderMCP) ⭐ 9,402 \| 🐛 223 \| 🌐 TypeScript \| 📅 2026-08-25                  | Local file/process control.                                                                                  |
...
| [browsermcp/mcp](https://github.com/browsermcp/mcp) ⭐ 7,016 \| 🐛 146 \| 🌐 TypeScript \| 📅 2025-04-24                                                  | Local Chrome control.                                                                                                         |
...
| [microsoft/playwright-mcp](https://github.com/microsoft/playwright-mcp) ⭐ 36,474 \| 🐛 6 \| 🌐 TypeScript \| 📅 2026-08-21                               | Official Playwright MCP.                                                                                                      |
...
| [eyalzh/browser-control-mcp](https://github.com/eyalzh/browser-control-mcp) ⭐ 318 \| 🐛 24 \| 🌐 TypeScript \| 📅 2026-08-23                             | Browser control MCP.                                                                                                          |
...
| [vostride/agent-qa](https://github.com/vostride/agent-qa) ⭐ 874 \| 🐛 0 \| 🌐 TypeScript \| 📅 2026-08-03                                                | Natural-language web and mobile regression testing through MCP with persistent memory and self-healing execution.             |

## ⚙️ Code Execution

| Repo                                                                                                                                                                | Notes                           |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------- |
| [pydantic/pydantic-ai (mcp-run-python)](https://github.com/pydantic/pydantic-ai/tree/main/packages/mcp-run-python) ⭐ 19,501 \| 🐛 733 \| 🌐 Python \| 📅 2026-08-26 | Run Python in a sandbox.        |
...
| Repo                                                                                                                            | Notes                                                                                                                                                                            |
| ------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [bgauryy/octocode-mcp](https://github.com/bgauryy/octocode-mcp) ⭐ 920 \| 🐛 3 \| 🌐 TypeScript \| 📅 2026-08-25                 | GitHub research + analysis agent.                                                                                                                                                |
| [oraios/serena](https://github.com/oraios/serena) ⭐ 28,499 \| 🐛 146 \| 🌐 Python \| 📅 2026-08-20                              | LSP-based coding agent.                                                                                                                                                          |
...
| [Necmttn/ax](https://github.com/Necmttn/ax) ⭐ 102 \| 🐛 43 \| 🌐 TypeScript \| 📅 2026-08-26                                    | Local telemetry and cost analytics for AI coding-agent sessions, tools, and skills.                                                                                              |
...
| [julien040/anyquery](https://github.com/julien040/anyquery) ⭐ 1,766 \| 🐛 8 \| 🌐 Go \| 📅 2026-08-16                                                    | SQL over 40+ apps.                                                                                                                                                           |
| [metatool-ai/metatool-app](https://github.com/metatool-ai/metatool-app) ⭐ 2,626 \| 🐛 105 \| 🌐 TypeScript \| 📅 2026-06-22                              | MetaMCP with GUI.                                                                                                                                                            |
| [mindsdb/mindsdb](https://github.com/mindsdb/mindsdb) ⭐ 39,643 \| 🐛 2 \| 🌐 Makefile \| 📅 2026-08-21                                                   | Data unification + MCP.                                                                                                                                                      |
...
| [PipedreamHQ/pipedream](https://github.com/PipedreamHQ/pipedream/tree/master/packages/mcp-server) ⭐ 11,649 \| 🐛 4,353 \| 🌐 JavaScript \| 📅 2026-08-26 | 2,500+ API integrations.                                                                                                                                                     |
...
|                  |                                                                                                                          |
| ---------------- | ------------------------------------------------------------------------------------------------------------------------ |
| **Repo**         | [jenkinsci/mcp-server-plugin](https://github.com/jenkinsci/mcp-server-plugin) ⭐ 106 \| 🐛 32 \| 🌐 Java \| 📅 2026-08-24 |
...
|                  |                                                                                                                                                                                                                                                       |
| ---------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Repo**         | [ghost-in-the-droid/android-agent](https://github.com/ghost-in-the-droid/android-agent) ⭐ 322 \| 🐛 1 \| 🌐 Python \| 📅 2026-08-13                                                                                                                   |
| **Maintainer**   | 👥 Community                                                                                                                                                                                                                                          |
...
| [nowork-studio/toprank](https://github.com/nowork-studio/toprank) ⭐ 3,406 \| 🐛 12 \| 🌐 TypeScript \| 📅 2026-08-26 | NotFair Google Ads MCP server. Diagnose campaigns, recommend optimizations, execute approved changes via the Google Ads API. |
...
|                |                                                                                               |
| -------------- | --------------------------------------------------------------------------------------------- |
| **Repo**       | [awslabs/mcp](https://github.com/awslabs/mcp) ⭐ 9,637 \| 🐛 263 \| 🌐 Python \| 📅 2026-08-26 |
...
|                  |                                                                                                                                            |
| ---------------- | ------------------------------------------------------------------------------------------------------------------------------------------ |
| **Repo**         | [cloudflare/mcp-server-cloudflare](https://github.com/cloudflare/mcp-server-cloudflare) ⭐ 4,113 \| 🐛 56 \| 🌐 TypeScript \| 📅 2026-08-24 |
...
|                    |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| ------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Repo**           | [aliyun/alibaba-cloud-ops-mcp-server](https://github.com/aliyun/alibaba-cloud-ops-mcp-server) ⭐ 127 \| 🐛 4 \| 🌐 Python \| 📅 2026-03-16                                                                                                                                                                                                                                                                                                                                             |
...
|                  |                                                                                                                                                                    |
| ---------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **Repo**         | [grafana/mcp-grafana](https://github.com/grafana/mcp-grafana) ⭐ 3,390 \| 🐛 112 \| 🌐 Go \| 📅 2026-08-25                                                          |
...
|                  |                                                                                                                              |
| ---------------- | ---------------------------------------------------------------------------------------------------------------------------- |
| **Repo**         | [TANTIOPE/datadog-mcp-server](https://github.com/TANTIOPE/datadog-mcp-server) ⭐ 5 \| 🐛 15 \| 🌐 TypeScript \| 📅 2026-08-25 |
| **Maintainer**   | 👥 Community                                                                                                                 |
...
|                  |                                                                                                                                                            |
| ---------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Repo**         | [VictoriaMetrics-Community/mcp-victoriametrics](https://github.com/VictoriaMetrics-Community/mcp-victoriametrics) ⭐ 221 \| 🐛 22 \| 🌐 Go \| 📅 2026-08-23 |
...
| Repo                                                                                                                          | Notes                                                                                         |
| ----------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------- |
| [dynatrace-oss/dynatrace-mcp](https://github.com/dynatrace-oss/dynatrace-mcp) ⭐ 135 \| 🐛 0 \| 🌐 TypeScript \| 📅 2026-08-19 | Dynatrace monitoring integration.                                                             |
| [last9/last9-mcp-server](https://github.com/last9/last9-mcp-server) ⭐ 59 \| 🐛 17 \| 🌐 Go \| 📅 2026-08-25                   | Last9 observability.                                                                          |
...
| [LaurieWired/GhidraMCP](https://github.com/LaurieWired/GhidraMCP) ⭐ 9,861 \| 🐛 82 \| 🌐 Java \| 📅 2025-06-23                       | Ghidra reverse engineering.                                                                                                                                                                                                                                                                                     |
...
|                  |                                                                                                                                      |
| ---------------- | ------------------------------------------------------------------------------------------------------------------------------------ |
| **Repo**         | [atlassian/atlassian-mcp-server](https://github.com/atlassian/atlassian-mcp-server) ⭐ 984 \| 🐛 83 \| 🌐 JavaScript \| 📅 2026-08-24 |
...
Community alternative with Server/Data Center support: [sooperset/mcp-atlassian](https://github.com/sooperset/mcp-atlassian) ⭐ 5,791 | 🐛 193 | 🌐 Python | 📅 2026-08-24.
...
| Repo                                                                                                             | Notes                  |
| ---------------------------------------------------------------------------------------------------------------- | ---------------------- |
| [effytech/freshdesk\_mcp](https://github.com/effytech/freshdesk_mcp) ⭐ 67 \| 🐛 12 \| 🌐 Python \| 📅 2026-07-30 | Freshdesk integration. |
...
|                  |                                                                                                                                     |
| ---------------- | ----------------------------------------------------------------------------------------------------------------------------------- |
| **Repo**         | [makenotion/notion-mcp-server](https://github.com/makenotion/notion-mcp-server) ⭐ 4,605 \| 🐛 187 \| 🌐 TypeScript \| 📅 2026-07-25 |
...
* [awesome](https://github.com/sindresorhus/awesome) ⭐ 499,974 | 🐛 106 | 📅 2026-08-21
* [awesome-mcp-servers](https://github.com/punkpeye/awesome-mcp-servers) ⭐ 92,825 | 🐛 3,543 | 📅 2026-08-17
* [MCP Reference Servers](https://github.com/modelcontextprotocol/servers) ⭐ 89,863 | 🐛 548 | 🌐 TypeScript | 📅 2026-08-20
* [FastMCP (jlowin)](https://github.com/jlowin/fastmcp) ⭐ 27,382 | 🐛 284 | 🌐 Python | 📅 2026-08-25
* [awesome-mcp-clients](https://github.com/punkpeye/awesome-mcp-clients) ⭐ 6,555 | 🐛 78 | 📅 2026-06-07
