...
|                      |                                                                                                                      |
| -------------------- | -------------------------------------------------------------------------------------------------------------------- |
| **Repo**             | [github/github-mcp-server](https://github.com/github/github-mcp-server) ⭐ 32,480 \| 🐛 338 \| 🌐 Go \| 📅 2026-08-25 |
...
| [modelcontextprotocol/server-gitlab](https://github.com/modelcontextprotocol/servers/tree/main/server-gitlab) ⭐ 89,834 \| 🐛 542 \| 🌐 TypeScript \| 📅 2026-08-20 | Reference GitLab server implementation. |
...
| [modelcontextprotocol/server-git](https://github.com/modelcontextprotocol/servers/tree/main/server-git) ⭐ 89,834 \| 🐛 542 \| 🌐 TypeScript \| 📅 2026-08-20 | Reference local Git server implementation. |
...
|                  |                                                                                                                                |
| ---------------- | ------------------------------------------------------------------------------------------------------------------------------ |
| **Repo**         | [hashicorp/terraform-mcp-server](https://github.com/hashicorp/terraform-mcp-server) ⭐ 1,512 \| 🐛 48 \| 🌐 Go \| 📅 2026-08-24 |
...
|                  |                                                                                                                     |
| ---------------- | ------------------------------------------------------------------------------------------------------------------- |
| **Repo**         | [hashicorp/vault-mcp-server](https://github.com/hashicorp/vault-mcp-server) ⭐ 59 \| 🐛 21 \| 🌐 Go \| 📅 2026-08-20 |
...
|                   |                                                                                                                                    |
| ----------------- | ---------------------------------------------------------------------------------------------------------------------------------- |
| **Repo**          | [containers/kubernetes-mcp-server](https://github.com/containers/kubernetes-mcp-server) ⭐ 2,018 \| 🐛 94 \| 🌐 Go \| 📅 2026-08-24 |
...
| [manusa/kubernetes-mcp-server](https://github.com/manusa/kubernetes-mcp-server) ⭐ 2,018 \| 🐛 94 \| 🌐 Go \| 📅 2026-08-24    | Kubernetes + OpenShift support.                                                                      |
...
| [kubestellar/console](https://github.com/kubestellar/console) ⭐ 127 \| 🐛 49 \| 🌐 TypeScript \| 📅 2026-08-25                | AI-powered multi-cluster management dashboard with MCP server (kc-agent) for AI-assisted operations. |
...
|                  |                                                                                                     |
| ---------------- | --------------------------------------------------------------------------------------------------- |
| **Repo**         | [docker/hub-mcp](https://github.com/docker/hub-mcp) ⭐ 162 \| 🐛 4 \| 🌐 TypeScript \| 📅 2026-08-20 |
...
| [wonderwhy-er/DesktopCommanderMCP](https://github.com/wonderwhy-er/DesktopCommanderMCP) ⭐ 9,388 \| 🐛 222 \| 🌐 TypeScript \| 📅 2026-08-21                  | Local file/process control.                                                                                  |
...
| [browsermcp/mcp](https://github.com/browsermcp/mcp) ⭐ 7,014 \| 🐛 146 \| 🌐 TypeScript \| 📅 2025-04-24                                                  | Local Chrome control.                                                                                                         |
...
| [microsoft/playwright-mcp](https://github.com/microsoft/playwright-mcp) ⭐ 36,440 \| 🐛 6 \| 🌐 TypeScript \| 📅 2026-08-21                               | Official Playwright MCP.                                                                                                      |
...
| Repo                                                                                                                                                                | Notes                           |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------- |
| [pydantic/pydantic-ai (mcp-run-python)](https://github.com/pydantic/pydantic-ai/tree/main/packages/mcp-run-python) ⭐ 19,487 \| 🐛 730 \| 🌐 Python \| 📅 2026-08-25 | Run Python in a sandbox.        |
...
| Repo                                                                                                                            | Notes                                                                                                                                                                            |
| ------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [bgauryy/octocode-mcp](https://github.com/bgauryy/octocode-mcp) ⭐ 921 \| 🐛 3 \| 🌐 TypeScript \| 📅 2026-08-18                 | GitHub research + analysis agent.                                                                                                                                                |
| [oraios/serena](https://github.com/oraios/serena) ⭐ 28,468 \| 🐛 140 \| 🌐 Python \| 📅 2026-08-20                              | LSP-based coding agent.                                                                                                                                                          |
...
| [jinzcdev/leetcode-mcp-server](https://github.com/jinzcdev/leetcode-mcp-server) ⭐ 140 \| 🐛 0 \| 🌐 TypeScript \| 📅 2026-07-12 | LeetCode (global/China) access.                                                                                                                                                  |
| [willibrandon/CursorMCPMonitor](https://github.com/willibrandon/CursorMCPMonitor) ⭐ 12 \| 🐛 0 \| 🌐 C# \| 📅 2025-03-12        | MCP monitoring for Cursor.                                                                                                                                                       |
| [Necmttn/ax](https://github.com/Necmttn/ax) ⭐ 101 \| 🐛 71 \| 🌐 TypeScript \| 📅 2026-08-25                                    | Local telemetry and cost analytics for AI coding-agent sessions, tools, and skills.                                                                                              |
...
| [PipedreamHQ/pipedream](https://github.com/PipedreamHQ/pipedream/tree/master/packages/mcp-server) ⭐ 11,647 \| 🐛 4,350 \| 🌐 JavaScript \| 📅 2026-08-25 | 2,500+ API integrations.                                                                                                                                                     |
...
| [nowork-studio/toprank](https://github.com/nowork-studio/toprank) ⭐ 3,401 \| 🐛 12 \| 🌐 TypeScript \| 📅 2026-08-25 | NotFair Google Ads MCP server. Diagnose campaigns, recommend optimizations, execute approved changes via the Google Ads API. |
...
|                  |                                                                                                                                            |
| ---------------- | ------------------------------------------------------------------------------------------------------------------------------------------ |
| **Repo**         | [cloudflare/mcp-server-cloudflare](https://github.com/cloudflare/mcp-server-cloudflare) ⭐ 4,108 \| 🐛 55 \| 🌐 TypeScript \| 📅 2026-08-24 |
...
|                  |                                                                                                                                                                    |
| ---------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **Repo**         | [grafana/mcp-grafana](https://github.com/grafana/mcp-grafana) ⭐ 3,385 \| 🐛 125 \| 🌐 Go \| 📅 2026-08-25                                                          |
...
| [LaurieWired/GhidraMCP](https://github.com/LaurieWired/GhidraMCP) ⭐ 9,859 \| 🐛 82 \| 🌐 Java \| 📅 2025-06-23                       | Ghidra reverse engineering.                                                                                                                                                                                                                                                                                     |
...
|                  |                                                                                                                                     |
| ---------------- | ----------------------------------------------------------------------------------------------------------------------------------- |
| **Repo**         | [makenotion/notion-mcp-server](https://github.com/makenotion/notion-mcp-server) ⭐ 4,603 \| 🐛 187 \| 🌐 TypeScript \| 📅 2026-07-25 |
...
* [MCP Reference Servers](https://github.com/modelcontextprotocol/servers) ⭐ 89,834 | 🐛 542 | 🌐 TypeScript | 📅 2026-08-20
* [FastMCP (jlowin)](https://github.com/jlowin/fastmcp) ⭐ 27,367 | 🐛 283 | 🌐 Python | 📅 2026-08-25
* [awesome-mcp-clients](https://github.com/punkpeye/awesome-mcp-clients) ⭐ 6,554 | 🐛 78 | 📅 2026-06-07
