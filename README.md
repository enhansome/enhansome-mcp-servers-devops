...
|                      |                                                                                                                      |
| -------------------- | -------------------------------------------------------------------------------------------------------------------- |
| **Repo**             | [github/github-mcp-server](https://github.com/github/github-mcp-server) ⭐ 32,432 \| 🐛 330 \| 🌐 Go \| 📅 2026-08-21 |
...
| [modelcontextprotocol/server-gitlab](https://github.com/modelcontextprotocol/servers/tree/main/server-gitlab) ⭐ 89,786 \| 🐛 535 \| 🌐 TypeScript \| 📅 2026-08-20 | Reference GitLab server implementation. |
...
| [modelcontextprotocol/server-git](https://github.com/modelcontextprotocol/servers/tree/main/server-git) ⭐ 89,786 \| 🐛 535 \| 🌐 TypeScript \| 📅 2026-08-20 | Reference local Git server implementation. |
...
|                  |                                                                                                                                |
| ---------------- | ------------------------------------------------------------------------------------------------------------------------------ |
| **Repo**         | [hashicorp/terraform-mcp-server](https://github.com/hashicorp/terraform-mcp-server) ⭐ 1,511 \| 🐛 46 \| 🌐 Go \| 📅 2026-08-21 |
...
| [nwiizo/tfmcp](https://github.com/nwiizo/tfmcp) ⭐ 371 \| 🐛 1 \| 🌐 Rust \| 📅 2026-08-20                                                         | Rust-based Terraform MCP server.      |
...
|                  |                                                                                                                     |
| ---------------- | ------------------------------------------------------------------------------------------------------------------- |
| **Repo**         | [hashicorp/vault-mcp-server](https://github.com/hashicorp/vault-mcp-server) ⭐ 58 \| 🐛 21 \| 🌐 Go \| 📅 2026-08-20 |
...
|                   |                                                                                                                                    |
| ----------------- | ---------------------------------------------------------------------------------------------------------------------------------- |
| **Repo**          | [containers/kubernetes-mcp-server](https://github.com/containers/kubernetes-mcp-server) ⭐ 1,996 \| 🐛 93 \| 🌐 Go \| 📅 2026-08-21 |
...
|                   |                                                                                                        |
| ----------------- | ------------------------------------------------------------------------------------------------------ |
| **Repo**          | [Azure/mcp-kubernetes](https://github.com/Azure/mcp-kubernetes) ⭐ 60 \| 🐛 8 \| 🌐 Go \| 📅 2026-08-11 |
...
|                   |                                                                                                                                     |
| ----------------- | ----------------------------------------------------------------------------------------------------------------------------------- |
| **Repo**          | [Flux159/mcp-server-kubernetes](https://github.com/Flux159/mcp-server-kubernetes) ⭐ 1,573 \| 🐛 6 \| 🌐 TypeScript \| 📅 2026-08-08 |
...
| Repo                                                                                                                          | Notes                                                                                                |
| ----------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------- |
| [rohitg00/kubectl-mcp-server](https://github.com/rohitg00/kubectl-mcp-server) ⭐ 954 \| 🐛 6 \| 🌐 Python \| 📅 2026-04-08     | Kubernetes CLI via MCP (read/write).                                                                 |
...
| [manusa/kubernetes-mcp-server](https://github.com/manusa/kubernetes-mcp-server) ⭐ 1,996 \| 🐛 93 \| 🌐 Go \| 📅 2026-08-21    | Kubernetes + OpenShift support.                                                                      |
| [strowk/mcp-k8s-go](https://github.com/strowk/mcp-k8s-go) ⭐ 386 \| 🐛 11 \| 🌐 Go \| 📅 2025-12-22                            | Go-based Kubernetes operations.                                                                      |
| [weibaohui/k8m](https://github.com/weibaohui/k8m) ⭐ 873 \| 🐛 25 \| 🌐 Go \| 📅 2026-08-14                                    | Multi-cluster management + UI.                                                                       |
...
| [kubestellar/console](https://github.com/kubestellar/console) ⭐ 127 \| 🐛 32 \| 🌐 TypeScript \| 📅 2026-08-23                | AI-powered multi-cluster management dashboard with MCP server (kc-agent) for AI-assisted operations. |
...
|                  |                                                                                                     |
| ---------------- | --------------------------------------------------------------------------------------------------- |
| **Repo**         | [docker/hub-mcp](https://github.com/docker/hub-mcp) ⭐ 161 \| 🐛 4 \| 🌐 TypeScript \| 📅 2026-08-20 |
...
|                  |                                                                                                                              |
| ---------------- | ---------------------------------------------------------------------------------------------------------------------------- |
| **Repo**         | [solomon2773/nora](https://github.com/solomon2773/nora) ⭐ 47 \| 🐛 17 \| 🌐 TypeScript \| 📅 2026-08-22                      |
...
|                  |                                                                                                                   |
| ---------------- | ----------------------------------------------------------------------------------------------------------------- |
| **Repo**         | [portainer/portainer-mcp](https://github.com/portainer/portainer-mcp) ⭐ 220 \| 🐛 7 \| 🌐 Python \| 📅 2026-08-13 |
...
| [g0t4/mcp-server-commands](https://github.com/g0t4/mcp-server-commands) ⭐ 231 \| 🐛 8 \| 🌐 TypeScript \| 📅 2026-08-22                                      | Run commands and scripts via MCP.                                                                            |
...
| [tumf/mcp-shell-server](https://github.com/tumf/mcp-shell-server) ⭐ 189 \| 🐛 0 \| 🌐 Python \| 📅 2026-08-15                                                | Shell command execution server.                                                                              |
...
| [wonderwhy-er/DesktopCommanderMCP](https://github.com/wonderwhy-er/DesktopCommanderMCP) ⭐ 9,379 \| 🐛 216 \| 🌐 TypeScript \| 📅 2026-08-21                  | Local file/process control.                                                                                  |
| [automateyournetwork/pyATS\_MCP](https://github.com/automateyournetwork/pyATS_MCP) ⭐ 81 \| 🐛 0 \| 🌐 Python \| 📅 2026-08-22                                | Cisco pyATS network automation.                                                                              |
...
| [browsermcp/mcp](https://github.com/browsermcp/mcp) ⭐ 7,009 \| 🐛 146 \| 🌐 TypeScript \| 📅 2025-04-24                                                  | Local Chrome control.                                                                                                         |
...
| [microsoft/playwright-mcp](https://github.com/microsoft/playwright-mcp) ⭐ 36,373 \| 🐛 3 \| 🌐 TypeScript \| 📅 2026-08-21                               | Official Playwright MCP.                                                                                                      |
| [co-browser/browser-use-mcp-server](https://github.com/co-browser/browser-use-mcp-server) ⭐ 843 \| 🐛 19 \| 🌐 Python \| 📅 2026-05-20                   | browser-use with SSE transport.                                                                                               |
| [eyalzh/browser-control-mcp](https://github.com/eyalzh/browser-control-mcp) ⭐ 316 \| 🐛 23 \| 🌐 TypeScript \| 📅 2026-08-22                             | Browser control MCP.                                                                                                          |
| [ndthanhdev/mcp-browser-kit](https://github.com/ndthanhdev/mcp-browser-kit) ⭐ 54 \| 🐛 6 \| 🌐 TypeScript \| 📅 2026-08-22                               | Browser automation toolkit.                                                                                                   |
...
| [scrapeless-ai/scrapeless-mcp-server](https://github.com/scrapeless-ai/scrapeless-mcp-server) ⭐ 168 \| 🐛 1 \| 🌐 TypeScript \| 📅 2026-08-21            | SERP and web data access.                                                                                                     |
...
| [vostride/agent-qa](https://github.com/vostride/agent-qa) ⭐ 935 \| 🐛 0 \| 🌐 TypeScript \| 📅 2026-08-03                                                | Natural-language web and mobile regression testing through MCP with persistent memory and self-healing execution.             |

## ⚙️ Code Execution

| Repo                                                                                                                                                                | Notes                           |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------- |
| [pydantic/pydantic-ai (mcp-run-python)](https://github.com/pydantic/pydantic-ai/tree/main/packages/mcp-run-python) ⭐ 19,445 \| 🐛 720 \| 🌐 Python \| 📅 2026-08-22 | Run Python in a sandbox.        |
...
| Repo                                                                                                                            | Notes                                                                                                                                                                            |
| ------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [bgauryy/octocode-mcp](https://github.com/bgauryy/octocode-mcp) ⭐ 917 \| 🐛 3 \| 🌐 TypeScript \| 📅 2026-08-18                 | GitHub research + analysis agent.                                                                                                                                                |
| [oraios/serena](https://github.com/oraios/serena) ⭐ 28,379 \| 🐛 120 \| 🌐 Python \| 📅 2026-08-20                              | LSP-based coding agent.                                                                                                                                                          |
| [ezyang/codemcp](https://github.com/ezyang/codemcp) ⭐ 1,608 \| 🐛 78 \| 🌐 Python \| 📅 2025-12-25                              | Simple coding agent MCP.                                                                                                                                                         |
| [Wolfe-Jam/claude-faf-mcp](https://github.com/Wolfe-Jam/claude-faf-mcp) ⭐ 22 \| 🐛 1 \| 🌐 TypeScript \| 📅 2026-08-20          | Persistent project context tools.                                                                                                                                                |
...
| [Necmttn/ax](https://github.com/Necmttn/ax) ⭐ 100 \| 🐛 74 \| 🌐 TypeScript \| 📅 2026-08-21                                    | Local telemetry and cost analytics for AI coding-agent sessions, tools, and skills.                                                                                              |
...
| [maxbaluev/accreted-intelligence](https://github.com/maxbaluev/accreted-intelligence) ⭐ 6 \| 🐛 2 \| 🌐 Shell \| 📅 2026-07-05  | Local-first Work Model MCP server for coding agents: scored memory plus outcome-credited actions through `acc_retrieve` and `acc_act`, with `acc.db` kept on the user's machine. |
...
| [julien040/anyquery](https://github.com/julien040/anyquery) ⭐ 1,763 \| 🐛 6 \| 🌐 Go \| 📅 2026-08-16                                                    | SQL over 40+ apps.                                                                                                                                                           |
| [metatool-ai/metatool-app](https://github.com/metatool-ai/metatool-app) ⭐ 2,618 \| 🐛 105 \| 🌐 TypeScript \| 📅 2026-06-22                              | MetaMCP with GUI.                                                                                                                                                            |
| [mindsdb/mindsdb](https://github.com/mindsdb/mindsdb) ⭐ 39,635 \| 🐛 2 \| 🌐 Makefile \| 📅 2026-08-21                                                   | Data unification + MCP.                                                                                                                                                      |
| [glenngillen/mcpmcp-server](https://github.com/glenngillen/mcpmcp-server) ⭐ 35 \| 🐛 3 \| 📅 2025-04-24                                                  | MCP server registry.                                                                                                                                                         |
| [wegotdocs/open-mcp](https://github.com/wegotdocs/open-mcp) ⭐ 368 \| 🐛 0 \| 🌐 Shell \| 📅 2026-08-21                                                   | Turn web APIs into MCP.                                                                                                                                                      |
| [PipedreamHQ/pipedream](https://github.com/PipedreamHQ/pipedream/tree/master/packages/mcp-server) ⭐ 11,638 \| 🐛 4,323 \| 🌐 JavaScript \| 📅 2026-08-22 | 2,500+ API integrations.                                                                                                                                                     |
...
| [waystation-ai/mcp](https://github.com/waystation-ai/mcp) ⭐ 61 \| 🐛 1 \| 🌐 JavaScript \| 📅 2025-09-10                                                 | Connect MCP hosts to apps.                                                                                                                                                   |
...
| [Find MCP](https://github.com/agentage/find-mcp) ⭐ 5 \| 🐛 0 \| 🌐 TypeScript \| 📅 2026-08-22                                                           | Search 17,000+ MCP servers from the official MCP registry, remote (Streamable HTTP, catalog.agentage.io/mcp) or stdio (npx @agentage/find-mcp), no auth needed for search.   |
...
|                  |                                                                                                            |
| ---------------- | ---------------------------------------------------------------------------------------------------------- |
| **Repo**         | [akuity/argocd-mcp](https://github.com/akuity/argocd-mcp) ⭐ 557 \| 🐛 67 \| 🌐 TypeScript \| 📅 2026-08-11 |
...
|                  |                                                                                                                          |
| ---------------- | ------------------------------------------------------------------------------------------------------------------------ |
| **Repo**         | [jenkinsci/mcp-server-plugin](https://github.com/jenkinsci/mcp-server-plugin) ⭐ 105 \| 🐛 26 \| 🌐 Java \| 📅 2026-08-20 |
...
|                  |                                                                                                                                                                                                                                                       |
| ---------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Repo**         | [ghost-in-the-droid/android-agent](https://github.com/ghost-in-the-droid/android-agent) ⭐ 317 \| 🐛 1 \| 🌐 Python \| 📅 2026-08-13                                                                                                                   |
| **Maintainer**   | 👥 Community                                                                                                                                                                                                                                          |
...
| Repo                                                                                                                 | Notes                                                                                                                                                               |
| -------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [HarperZ9/telos](https://github.com/HarperZ9/telos) ⭐ 2 \| 🐛 2 \| 🌐 Python \| 📅 2026-08-03                        | Local-first MCP/CLI workbench for inspectable DevOps agent workflows: workspace maps, CI triage, action receipts, context packs, and operator verification doctors. |
...
| Repo                                                                                                                 | Notes                                                                                                                        |
| -------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------- |
| [arvindand/maven-tools-mcp](https://github.com/arvindand/maven-tools-mcp) ⭐ 31 \| 🐛 0 \| 🌐 Java \| 📅 2026-08-19   | Maven and build tooling.                                                                                                     |
| [nowork-studio/toprank](https://github.com/nowork-studio/toprank) ⭐ 3,391 \| 🐛 12 \| 🌐 TypeScript \| 📅 2026-08-22 | NotFair Google Ads MCP server. Diagnose campaigns, recommend optimizations, execute approved changes via the Google Ads API. |
...
|                |                                                                                               |
| -------------- | --------------------------------------------------------------------------------------------- |
| **Repo**       | [awslabs/mcp](https://github.com/awslabs/mcp) ⭐ 9,630 \| 🐛 269 \| 🌐 Python \| 📅 2026-08-23 |
...
|                  |                                                                                                                                            |
| ---------------- | ------------------------------------------------------------------------------------------------------------------------------------------ |
| **Repo**         | [cloudflare/mcp-server-cloudflare](https://github.com/cloudflare/mcp-server-cloudflare) ⭐ 4,102 \| 🐛 56 \| 🌐 TypeScript \| 📅 2026-08-22 |
...
| **Also available** | 📦 [ACK (Kubernetes)](https://github.com/aliyun/alibabacloud-ack-mcp-server) ⭐ 115 \| 🐛 8 \| 🌐 Python \| 📅 2026-07-31, [DataWorks](https://github.com/aliyun/alibabacloud-dataworks-mcp-server) ⭐ 50 \| 🐛 11 \| 🌐 TypeScript \| 📅 2026-06-16, [DMS](https://github.com/aliyun/alibabacloud-dms-mcp-server) ⭐ 52 \| 🐛 16 \| 🌐 Python \| 📅 2026-07-29, [Function Compute](https://github.com/aliyun/alibabacloud-fc-mcp-server) ⭐ 8 \| 🐛 8 \| 🌐 JavaScript \| 📅 2026-02-14. |
...
|                  |                                                                                                                                                                    |
| ---------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **Repo**         | [grafana/mcp-grafana](https://github.com/grafana/mcp-grafana) ⭐ 3,379 \| 🐛 128 \| 🌐 Go \| 📅 2026-08-23                                                          |
...
|                  |                                                                                                                              |
| ---------------- | ---------------------------------------------------------------------------------------------------------------------------- |
| **Repo**         | [TANTIOPE/datadog-mcp-server](https://github.com/TANTIOPE/datadog-mcp-server) ⭐ 5 \| 🐛 15 \| 🌐 TypeScript \| 📅 2026-08-23 |
| **Maintainer**   | 👥 Community                                                                                                                 |
...
| Repo                                                                                                                                   | Lang       | Notes                                |
| -------------------------------------------------------------------------------------------------------------------------------------- | ---------- | ------------------------------------ |
| [pab1it0/prometheus-mcp-server](https://github.com/pab1it0/prometheus-mcp-server) ⭐ 512 \| 🐛 8 \| 🌐 Python \| 📅 2026-08-05          | 🐍 Python  | ⭐ 177 stars, well-documented.        |
...
|                  |                                                                                                                                                            |
| ---------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Repo**         | [VictoriaMetrics-Community/mcp-victoriametrics](https://github.com/VictoriaMetrics-Community/mcp-victoriametrics) ⭐ 215 \| 🐛 21 \| 🌐 Go \| 📅 2026-07-19 |
...
| Repo                                                                                                                          | Notes                                                                                         |
| ----------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------- |
| [dynatrace-oss/dynatrace-mcp](https://github.com/dynatrace-oss/dynatrace-mcp) ⭐ 134 \| 🐛 0 \| 🌐 TypeScript \| 📅 2026-08-19 | Dynatrace monitoring integration.                                                             |
| [last9/last9-mcp-server](https://github.com/last9/last9-mcp-server) ⭐ 59 \| 🐛 16 \| 🌐 Go \| 📅 2026-08-21                   | Last9 observability.                                                                          |
...
| Repo                                                                                                                                 | Notes                                                                                                                                                                                                                                                                                                           |
| ------------------------------------------------------------------------------------------------------------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [zyx77550/sparda](https://github.com/zyx77550/sparda) ⭐ 8 \| 🐛 8 \| 🌐 JavaScript \| 📅 2026-07-30                                  | Proof-Carrying Code and deterministic security gate for AI agents.                                                                                                                                                                                                                                              |
| [LaurieWired/GhidraMCP](https://github.com/LaurieWired/GhidraMCP) ⭐ 9,839 \| 🐛 82 \| 🌐 Java \| 📅 2025-06-23                       | Ghidra reverse engineering.                                                                                                                                                                                                                                                                                     |
| [13bm/GhidraMCP](https://github.com/13bm/GhidraMCP) ⭐ 134 \| 🐛 4 \| 🌐 Java \| 📅 2026-08-19                                        | Ghidra analysis tools.                                                                                                                                                                                                                                                                                          |
| [BurtTheCoder/mcp-shodan](https://github.com/BurtTheCoder/mcp-shodan) ⭐ 157 \| 🐛 5 \| 🌐 TypeScript \| 📅 2026-03-31                | Shodan search + CVE data.                                                                                                                                                                                                                                                                                       |
| [BurtTheCoder/mcp-virustotal](https://github.com/BurtTheCoder/mcp-virustotal) ⭐ 147 \| 🐛 6 \| 🌐 TypeScript \| 📅 2026-05-24        | VirusTotal scanning.                                                                                                                                                                                                                                                                                            |
...
| [ezequiellich44-cmd/MandateGuard](https://github.com/ezequiellich44-cmd/MandateGuard) ⭐ 0 \| 🐛 0 \| 🌐 Python \| 📅 2026-08-21      | Deterministic payment policy enforcement for AI agents: pre-action gate enforcing budgets, allowlists, denylists, rate limits, and signed Ed25519 payment mandates with zero LLM in the decision path. Tamper-evident SHA-256 chained audit ledger; official MCP server on the Model Context Protocol Registry. |
...
|                  |                                                                                                                                      |
| ---------------- | ------------------------------------------------------------------------------------------------------------------------------------ |
| **Repo**         | [atlassian/atlassian-mcp-server](https://github.com/atlassian/atlassian-mcp-server) ⭐ 980 \| 🐛 84 \| 🌐 JavaScript \| 📅 2026-07-27 |
...
Community alternative with Server/Data Center support: [sooperset/mcp-atlassian](https://github.com/sooperset/mcp-atlassian) ⭐ 5,784 | 🐛 191 | 🌐 Python | 📅 2026-08-20.
...
|                  |                                                                                                                                     |
| ---------------- | ----------------------------------------------------------------------------------------------------------------------------------- |
| **Repo**         | [makenotion/notion-mcp-server](https://github.com/makenotion/notion-mcp-server) ⭐ 4,598 \| 🐛 187 \| 🌐 TypeScript \| 📅 2026-07-25 |
...
* [awesome](https://github.com/sindresorhus/awesome) ⭐ 499,024 | 🐛 106 | 📅 2026-08-21
* [awesome-mcp-servers](https://github.com/punkpeye/awesome-mcp-servers) ⭐ 92,699 | 🐛 3,353 | 📅 2026-08-17
* [MCP Reference Servers](https://github.com/modelcontextprotocol/servers) ⭐ 89,786 | 🐛 535 | 🌐 TypeScript | 📅 2026-08-20
* [FastMCP (jlowin)](https://github.com/jlowin/fastmcp) ⭐ 27,334 | 🐛 274 | 🌐 Python | 📅 2026-08-22
* [awesome-mcp-clients](https://github.com/punkpeye/awesome-mcp-clients) ⭐ 6,551 | 🐛 74 | 📅 2026-06-07
* [FastMCP (punkpeye)](https://github.com/punkpeye/fastmcp) ⭐ 3,253 | 🐛 10 | 🌐 TypeScript | 📅 2026-08-21
